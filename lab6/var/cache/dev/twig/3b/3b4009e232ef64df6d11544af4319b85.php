...
class __TwigTemplate_e78204b5697bbd3a2674e4c2b8d68806 extends Template
{
            ...
            foreach ($context['_seq'] as $context["name"] => $context["client"]) {
                ...
                if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["client"], "traces", [], "any", false, false, false, 61)) == 0)) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["trace"]) {
                        ...
                        // line 97
                        yield "                                        ";
                        if ((($tmp =  !(null === CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "curlCommand", [], "any", false, false, false, 97))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                            // line 98
                            yield "                                            <th>
                        ...
                        yield "
                                        ...
                                        <td";
                        // line 118
                        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "curlCommand", [], "any", false, false, false, 118)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                            yield " colspan=\"2\"";
                        }
                        yield ">
                                            ";
...
{% endblock %}
", "@WebProfiler/Collector/http_client.html.twig", "C:\\xampp\\htdocs\\tp_symfony\\lab6\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\http_client.html.twig");
    }
}
